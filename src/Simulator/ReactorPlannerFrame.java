...
public class ReactorPlannerFrame extends javax.swing.JFrame {
    ...
    private void resourcePackItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_resourcePackItemActionPerformed
...
//        }
    ...
    private void clearGridButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_clearGridButtonActionPerformed
        reactor.clearGrid();
    ...
    private void simulateButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_simulateButtonActionPerformed
        SpinnerModel model = heatSpinner.getModel();
        if (model instanceof SpinnerNumberModel) {
            ((SpinnerNumberModel) model).setMaximum(reactor.getMaxHeat());
        }
    ...
    private void euReactorRadioActionPerformed(ActionEvent evt) {//GEN-FIRST:event_euReactorRadioActionPerformed
        reactor.setFluid(false);
    }//GEN-LAST:event_euReactorRadioActionPerformed

    private void fluidReactorRadioActionPerformed(ActionEvent evt) {//GEN-FIRST:event_fluidReactorRadioActionPerformed
        reactor.setFluid(true);
    }//GEN-LAST:event_fluidReactorRadioActionPerformed

    private void copyCodeButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_copyCodeButtonActionPerformed
    ...
    private void pasteCodeButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_pasteCodeButtonActionPerformed
        try {
